...
/* harmony import */ var _wordpress_editPost__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/editPost */ "@wordpress/editPost");
/* harmony import */ var _wordpress_editPost__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_editPost__WEBPACK_IMPORTED_MODULE_2__);
...
function usePostMeta(fieldName) {
  ...
  const value = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
    var _select$getEditedPost;

    return (_select$getEditedPost = select('core/editor').getEditedPostAttribute('meta')) === null || _select$getEditedPost === void 0 ? void 0 : _select$getEditedPost[fieldName];
  }, [fieldName]);
  const editValue = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(newValue => {
    editPost({
      meta: {
        [fieldName]: newValue
      }
...
const WabiColors = _ref => {
  ...
  const checkIcon = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_icons__WEBPACK_IMPORTED_MODULE_7__["default"], {
    icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_8__["default"],
    size: 28
  });
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_editPost__WEBPACK_IMPORTED_MODULE_2__.PluginPostStatusInfo, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelRow, {
    className: "components-wabi-accent-color-row"
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Accent color'),
    isBlock: true
...
const WabiColorswithSelect = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_6__.compose)([(0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.withSelect)(select => {
  return {
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_1__.registerPlugin)('wabi-colors', {
  render: WabiColorswithSelect
});
}();
/******/ })()
;
