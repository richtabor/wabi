...
return array(
	...
	'content'    => '
		...
		<h2 class="has-text-align-center has-xx-large-font-size" id="style-guide">' . esc_html__( 'Page Heading', 'wabi' ) . '</h2>
		<!-- /wp:heading -->

		<!-- wp:heading {"textAlign":"center","style":{"typography":{"letterSpacing":"0px","fontStyle":"normal","fontWeight":"400"}},"fontSize":"medium"} -->
		<h2 class="has-text-align-center has-medium-font-size" id="style-guide" style="font-style:normal;font-weight:400;letter-spacing:0px">' . esc_html__( 'Add a sub title right here', 'wabi' ) . '</h2>
		<!-- /wp:heading --></div>
		<!-- /wp:group --></div></div>
		<!-- /wp:cover -->',
);
